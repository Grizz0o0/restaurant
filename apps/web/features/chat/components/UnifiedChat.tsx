...
import type { AIMessage } from '@/features/chat/hooks/use-ai-chat';

type UnifiedMessage =
    | (AIMessage & { type: 'AI'; createdAt: Date })
    | (Message & { type: 'ADMIN'; isFromMe: boolean });
...
export const UnifiedChat = () => {
    ...
    const activeMessages: UnifiedMessage[] =
        mode === 'AI'
            ? aiMessages.map((m) => ({
                  ...m,
                  type: 'AI',
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col">
                                                    <div
                                                        className={cn(
                                                            'p-3 rounded-2xl text-sm leading-relaxed shadow-sm wrap-break-word',
                                                            isFromMe
