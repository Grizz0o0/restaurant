...
import { CreateInventoryBodySchema } from '@repo/schema';

type InventoryFormValues = z.infer<typeof CreateInventoryBodySchema>;
...
export function InventoryList({ restaurantId }: { restaurantId: string }) {
    ...
    const form = useForm<InventoryFormValues>({
        resolver: zodResolver(CreateInventoryBodySchema) as Resolver<InventoryFormValues>,
        defaultValues: {
            restaurantId: '',
            supplierId: '',
            itemName: '',
