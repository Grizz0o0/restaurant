...
import { z } from 'zod';
import type { UserDetailResType, OrderType, RoleType } from '@repo/schema';
import {
    Plus,
    Pencil,
    Loader2,
                    ...
                    <div className="flex flex-col items-center gap-3 py-6 border-b">
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex items-center gap-2 mt-1 justify-center flex-wrap">
                                ...
                                <UserStatusBadge status={user.status || undefined} />
                            </div>
                        </div>
                    </div>
...
export default function AdminUsersPage() {
    ...
    const [editing, setEditing] = useState<UserDetailResType | null>(null);
    const [selectedUser, setSelectedUser] = useState<UserDetailResType | null>(null);
    ...
    const openEdit = (user: UserDetailResType) => {
        setDrawerOpen(false);
        setEditing(user);
        form.reset({
            name: user.name || '',
    ...
    const handleRowClick = (user: UserDetailResType) => {
