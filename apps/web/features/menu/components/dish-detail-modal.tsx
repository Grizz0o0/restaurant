    ...
    useEffect(() => {
        if (dish?.variants && dish.variants.length > 0) {
            ...
            dish.variants.forEach((variant) => {
                ...
                if (firstOption) {
                    initialOptions[variant.id] = firstOption.id;
                }
            });
    ...
    const handleAddToCart = () => {
        ...
        if (dish.variants && dish.variants.length > 0) {
            ...
            const defaultSku = dish.skus?.find(
                (s) => !s.variantOptions || s.variantOptions.length === 0,
            );
            if (defaultSku) {
                                                ...
                                                (option) => (
                                                    <div key={option.id}>
                                                        ...
                                                        >
                                                            ...
                                                            {(option as { priceModifier: number }).priceModifier >
                                                                0 && (
